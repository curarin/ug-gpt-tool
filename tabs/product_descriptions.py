...
def generate_product_description(gpt_version_wanted, gpt_temp_wanted, gpt_top_p_wanted, lang_wanted):
    ...
    if st.button("Generate deal content"):
        # gpt api calling
        product_content, product_content_cost, product_content__gptversion = gptapi.openAI_content(product_act_as_prompt, product_content_prompt, gpt_temp_wanted, gpt_top_p_wanted, gpt_version_wanted)
        product_headline, product_headline_cost, product_headline_gptversion = gptapi.openAI_content(product_act_as_prompt, product_headline_prompt, gpt_temp_wanted, gpt_top_p_wanted, gpt_version_wanted)
        product_description, product_description_cost, product_description_gptversion = gptapi.openAI_content(product_act_as_prompt, product_description_prompt, gpt_temp_wanted, gpt_top_p_wanted, gpt_version_wanted)
        product_h1, product_h1_cost, product_h1__gptversion = gptapi.openAI_content(product_act_as_prompt, product_h1_prompt, gpt_temp_wanted, gpt_top_p_wanted, gpt_version_wanted)
        product_subheader, product_subheader_cost, product_subheader_gptversion = gptapi.openAI_content(product_act_as_prompt, product_subheader_prompt, gpt_temp_wanted, gpt_top_p_wanted, gpt_version_wanted)
        ...
        col1_google_tags, col2_google_tags = st.columns(2)
        with col1_google_tags:
            st.markdown("**Google Title Tag**")
            st.write(product_headline)
        with col2_google_tags:
