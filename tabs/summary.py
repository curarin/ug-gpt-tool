...
def get_summary(gpt_version_wanted, gpt_temp_wanted, lang_wanted):
    ...
    ### Input Fields
    with st.form(key = "input fields for summary"):
        ...
        form_submit_summary_input_values = st.form_submit_button(label = "Generate content")
