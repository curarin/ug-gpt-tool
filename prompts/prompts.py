...
def alt_tag_prompts(lang_wanted, image_url, image_context):
    content_prompt_alt_text = f"Verfasse einen Alt Text für das Bild {image_url} mit maximal 200 Zeichen auf {lang_wanted}. Baue {image_context} semantisch sinnvoll ein. Stelle dir vor, du möchtest einer sehbeeinträchtigten Person erklären, was auf dem Bild zu sehen ist. Welche Elemente siehst du? Wo sind sie platziert? Schreibe nicht 'das Bild zeigt...' sondern beschreibe es direkt."
